      ...
      {[
        {
          ...
          moreInfo: "Perfect for sales and marketing campaigns where outreach to thousands of leads is required with consistent messaging.",
        },
        {
          ...
          moreInfo: "Gain real-time insights on customer satisfaction, NPS scores, and service quality after each interaction.",
        },
        {
